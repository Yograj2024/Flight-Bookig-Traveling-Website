...
// relative h-[600px] flex m-[0px_0px_0px]
// before:content-[''] flex-col md:w-full
// before:h-full before:w-full justify-center
...
// text-center text-[1.5rem] md:text-[2.5rem] mt-[18px]
...
// h-[365px] w-[92%] sm:w-[300px] lg:w-[300px] lg:h-[400px] flex-shrink-0 relative m-[30px_auto_0] rounded-[20px] bg-cover bg-center
// before:content-[''] before:h-full before:w-full before:absolute 
