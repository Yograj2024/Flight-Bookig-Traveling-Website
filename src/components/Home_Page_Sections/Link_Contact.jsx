            ...
            <section className=''>
                <div className={`p-[70px_20px_0px] md:flex md:flex-col lg:flex-row md:max-w-[1440px] md:m-auto`}>
                    <div className={`m-[50px_0] md:m-0 md:p-[30px_0_0] md:w-ful lg:w-[380px] border-t-2 border-t-slate-700 p-[50px_0px_0px] md:border-none`}>
                        ...
                        <p className={`text-slate-400`}>Lasthrplan, a part of Almar International Limited, specializes in seamless flight bookings and hotel reservations. We offer personalized, budget-friendly travel solutions, ensuring an effortless and memorable journey for business and leisure travelers.</p>
                    </div>
                    ...
                    <div className='sm:grid sm:grid-cols-2 md:grid-cols-3 md:mt-[30px] lg:mt-0'>
                        ...
                        <div className={`m-[20px_0px] md:flex-[1%] md:p-[0_0_0_10px]`}>
                            <h5 className={`text-[1.8rem] text-white font-semibold text-center sm:text-left md:text-left mb-[30px]`}>Useful Links</h5>
                            <div className={`grid grid-cols-1 ex-s:grid-cols-[195px_1fr] md:grid-cols-1 `}>
                                { usefulLinks.map( (item,index) => <h6 className={`m-[5px_0px] text-slate-300`} key={`${index}_${item}`}> 
                                                        <i className="fa-solid fa-hand-point-right mr-[8px] text-slate-400"></i> 
                                                        <Link to={`/${item}`}> {item} </Link></h6> ) }
                            </div>
                        </div>
