...
const About = () => {
    ...
    return (
        <> 
            <section id="about" className={`element w-[98%] m-[50px_auto] flex relative flex-col items-end justify-end rounded-[18px]`}>
                <div className={`md:w-full md:h-full md:max-w-[1440px] md:m-auto md:flex md:justify-end md:gap-x-[20px]`}>
                    ...
                    <div className={`md:w-[50%]`}>
                        <div className={`md:pl-[20px] text-center`}>
                            ...
                            <h1 className={`text-[1.6rem] sm:text-[1.8rem] md:text-[2rem] font-semibold md:text-left`}> 
                        ...
                        <div className={``}>
                            {
                                aboutData.map((data, index )=>{
                                    return <div className={`w-[95%] rounded-[30px] flex flex-col sm:flex-row sm:justify-between items-center justify-center md:bg-opacity-0 gap-y-[10px] bg-gray-200 md:flex-row text-center sm:text-left md:text-start bg-opacity-30 md:justify-start m-[10px_auto] p-[25px_0px_30px] md:py-[10px]`} key={ index + data.id }>
